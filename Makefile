...
# Generated by qmake (3.0) (Qt 5.0.1) on: Sun Dec 1 22:31:36 2013
# Project:  P4.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/P41.0.0/ && $(COPY_FILE) --parents baseboggleplayer.h boggleboard.h boggleplayer.h boggleutil.h mainwindow.h ui_mainwindow.h .tmp/P41.0.0/ && $(COPY_FILE) --parents boggleboard.cpp boggleplayer.cpp boggleutil.cpp main.cpp mainwindow.cpp .tmp/P41.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/P41.0.0/ && (cd `dirname .tmp/P41.0.0` && $(TAR) P41.0.0.tar P41.0.0 && $(COMPRESS) P41.0.0.tar) && $(MOVE) `dirname .tmp/P41.0.0`/P41.0.0.tar.gz . && $(DEL_FILE) -r .tmp/P41.0.0
